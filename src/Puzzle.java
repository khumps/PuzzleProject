...
public class Puzzle {
	...
	// Constructs a puzzle with specified rows and cols and set of pieces to be
	// used
	...
	// checks if the board is full (when all places in the board contain a
	// piece).
	...
	// (ex. checks if the north edge of one piece matches to the south edge of
	// another)
