...
<<<<<<< HEAD
		 ...
		 * -2); pieces[4] = new Piece(-1,-4, 1, -2); pieces[7] = new
		 * Piece(-1,2,3, -3); pieces[2] = new Piece(2,1, -1, 3); pieces[5] = new
		 * Piece(1,2,3,4); pieces[8] = new Piece(-3,4, 2, -2);
		 */

		/*
		 * pieces[0] = new Piece(3, 1, -4, -3); pieces[1] = new Piece(2, 4, -2,
		 * -1); pieces[2] = new Piece(1, 2, -2, -3); pieces[3] = new Piece(1, 4,
		 * -3, -3); pieces[4] = new Piece(2, 2, -1, -3); pieces[5] = new
